...
const TogglButton = {
  ...
  stopTimeEntryPomodoro: function (timeEntry, isEndOfBreak = false) {
    return new Promise(async (resolve) => {
      ...
      // TODO: what a mess
      const pomodoroInterval = await (isEndOfBreak ? db.get(TogglButton.pomorodo.state === 'shortbreak' ? 'pomodoroBreakInterval' : 'pomodoroLongBreakInterval') : db.get('pomodoroInterval'));
